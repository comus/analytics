...
#define ESP_BLE_MESH_VND_MODEL_OP_STATUS2    ESP_BLE_MESH_MODEL_OP_3(0x02, CID_ESP)
#define ESP_BLE_MESH_VND_MODEL_OP_STATUS4    ESP_BLE_MESH_MODEL_OP_3(0x03, CID_ESP)
#define ESP_BLE_MESH_VND_MODEL_OP_STATUS8    ESP_BLE_MESH_MODEL_OP_3(0x04, CID_ESP)
#define ESP_BLE_MESH_VND_MODEL_OP_STATUS16    ESP_BLE_MESH_MODEL_OP_3(0x05, CID_ESP)
...
static esp_ble_mesh_model_op_t vnd_op[] = {
    ...
    ESP_BLE_MESH_MODEL_OP(ESP_BLE_MESH_VND_MODEL_OP_STATUS2, 2),
    ESP_BLE_MESH_MODEL_OP(ESP_BLE_MESH_VND_MODEL_OP_STATUS4, 2),
    ESP_BLE_MESH_MODEL_OP(ESP_BLE_MESH_VND_MODEL_OP_STATUS8, 2),
    ESP_BLE_MESH_MODEL_OP(ESP_BLE_MESH_VND_MODEL_OP_STATUS16, 2),
...
void example_ble_mesh_send_vendor_message_a()
{
    // 開始時
...
void example_ble_mesh_send_vendor_message_b()
{
    // 開始時
    esp_ble_mesh_msg_ctx_t ctx = {0};
    uint32_t opcode;
...
void example_ble_mesh_send_vendor_message_menu()
{
    // 開始時
    esp_ble_mesh_msg_ctx_t ctx = {0};
    uint32_t opcode;
    ...
    for (int i = 0; i < 1; ++i) {
        ...
        ctx.send_ttl = MSG_SEND_TTL;
        ctx.send_rel = MSG_SEND_REL;
        opcode = ESP_BLE_MESH_VND_MODEL_OP_STATUS2;
...
void example_ble_mesh_send_vendor_message_volume()
{
    // 開始時
    esp_ble_mesh_msg_ctx_t ctx = {0};
    uint32_t opcode;
    ...
    for (int i = 0; i < 1; ++i) {
        ...
        ctx.send_ttl = MSG_SEND_TTL;
        ctx.send_rel = MSG_SEND_REL;
        opcode = ESP_BLE_MESH_VND_MODEL_OP_STATUS4;
...
void example_ble_mesh_send_vendor_message_select()
{
    // 開始時
    esp_ble_mesh_msg_ctx_t ctx = {0};
    uint32_t opcode;
    ...
    for (int i = 0; i < 1; ++i) {
        ...
        ctx.send_ttl = MSG_SEND_TTL;
        ctx.send_rel = MSG_SEND_REL;
        opcode = ESP_BLE_MESH_VND_MODEL_OP_STATUS8;
...
void example_ble_mesh_send_vendor_message_start()
{
    // 開始時
    esp_ble_mesh_msg_ctx_t ctx = {0};
    uint32_t opcode;
    ...
    for (int i = 0; i < 100; ++i) {
        ...
        ctx.send_ttl = MSG_SEND_TTL;
        ctx.send_rel = MSG_SEND_REL;
        opcode = ESP_BLE_MESH_VND_MODEL_OP_STATUS16;
                                             ...
                                             esp_ble_mesh_model_cb_param_t *param)
{
    ...
    case ESP_BLE_MESH_CLIENT_MODEL_RECV_PUBLISH_MSG_EVT:;
        ...
        // 收到有人被按了b的訊息
        if (param->client_recv_publish_msg.opcode == ESP_BLE_MESH_VND_MODEL_OP_STATUS) {
            int64_t time = *(int64_t *)param->client_recv_publish_msg.msg;
            ESP_LOGI("[#]", ",0x%06x,%lld", param->client_recv_publish_msg.opcode, time);
        }
